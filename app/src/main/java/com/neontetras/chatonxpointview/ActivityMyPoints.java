package com.neontetras.chatonxpointview;
...
public class ActivityMyPoints extends AppCompatActivity implements View.OnClickListener{
    ...
    private final View.OnTouchListener mDelayHideTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
          ...
          Toast toast = Toast.makeText(ActivityMyPoints.this,"Implement Select Contact here", Toast.LENGTH_LONG);
    ...
    protected void onResume() {
        super.onResume();
            ...
            new PointNetwork(this,this).execute(
                    getString(R.string.server_url)+"points/get_user_points.php?user_id="+LOGGED_IN_USER);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.withdraw_point_button:
                Toast.makeText(this,"Implement withdrawal here",Toast.LENGTH_LONG).show();
                break;
